...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATHxDx
      implicit none
      INTEGER i
      INTEGER n
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATHxDxoR
      implicit none
      INTEGER i
      INTEGER n
      INTEGER vBDATBArtNr(n)
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBiomasse
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDAT20
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATRINDE2Hx
      implicit none
      INTEGER i
      INTEGER n
      INTEGER vBDATBArtNr(n)
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATDmRHx
      implicit none
      INTEGER i
      INTEGER n
      INTEGER vBDATBArtNr(n)
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATDoRHx
      implicit none
      INTEGER i
      INTEGER n
      INTEGER vBDATBArtNr(n)
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATVOLABmR
      implicit none
      INTEGER i
      INTEGER n
      INTEGER vBDATBArtNr(n)
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATVOLABoR
      implicit none
      INTEGER i
      INTEGER n
      INTEGER vBDATBArtNr(n)
...
!dec$ ATTRIBUTES  DLLEXPORT :: vBDATFormTarif
