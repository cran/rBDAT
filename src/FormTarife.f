...
c		MwQ03BWI = F(D,H)
c
c 		BDATBArtNr	INT*4	EIN	- BDAT BaumArt Nummer 1-36
c  		D			real EIN	- BHD [cm]
c 		H			real EIN	- BaumH�he [m]
c 		MwQ03BWI	real AUS - Mittelwert q0.3 (gesch�tzt)
c
c	****************************************************************************************

!dec$ ATTRIBUTES  DLLEXPORT :: BDATFormTarif
      	INTEGER Tarif
      	INTEGER BDATBArtNr
      	real D, H
      	real MwQ03BWI
...
!dec$ ATTRIBUTES  DLLEXPORT :: FNBDATFormTarif
...
c!dec$ ATTRIBUTES  DLLEXPORT :: xBDATFormTarif
